...
const Send = ({colorOne = '#45b649', colorTwo = '#dce35b'}: any) => {
  ...
  <defs>
    <linearGradient id="linear-gradient" x1="1" x2="0" y2="1.097" gradientUnits="objectBoundingBox">
      <stop offset="0" stop-color=${colorOne}/>
      <stop offset="1" stop-color=${colorTwo}/>
    </linearGradient>
  </defs>
  <g id="Down_arrow" data-name="Down arrow" transform="translate(7.071 14.142) rotate(-135)">
